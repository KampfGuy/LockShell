...
with sync_playwright() as p:
    ...
    open_app('camera'); page.click('text=Start camera'); page.wait_for_timeout(1500)
    page.click('.shutter'); page.wait_for_timeout(900)
    check(page.locator('.thumbs img').count() >= 1, 'camera captured a photo into IndexedDB'); back()
    ...
    check('Shopping' in page.inner_text('#appBody'), 'note autosaved'); back()
